...
export default function Footer() {
  return (
    <footer className="relative w-full">
      ...
      <div className="overflow-hidden w-full xl:flex xl:flex-col items-center relative bg-background">
        <div className="relative z-20 h-px w-full bg-linear-to-r from-transparent via-white/30 to-transparent"></div>
        ...
        <div className="w-full xl:max-w-6xl">
          ...
          <div className="py-14 pb-28 md:pb-14 flex justify-center">
            <span className="text-center text-muted-foreground">
              Copyright © {new Date().getFullYear()} Sayidina Ahmadal Qososyi.
              All rights reserved.
            </span>
          </div>
        </div>
