  ...
  return (
    ...
    >
      <div className="w-[40rem] relative">
        <div
          className={cn(
            'absolute inset-0  md:inset-x-20 bg-linear-to-r from-transparent via-emerald-400/80 to-transparent h-[5px] w-full md:w-3/4 blur-sm',
            position === 'top' ? 'top-0' : 'bottom-0',
          )}
        ></div>
        <div
          className={cn(
            'absolute inset-0  md:inset-x-20 bg-linear-to-r from-transparent via-emerald-400/80 to-transparent h-px w-full md:w-3/4',
            position === 'top' ? 'top-0' : 'bottom-0',
          )}
        ></div>
        <div
